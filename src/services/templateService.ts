...
export const PREBUILT_TEMPLATES: Record<string, TemplateDefinition> = {
  'one_bank_cc': {
    ...
    headers: [
      ...
      'TOTAL_LIMIT', 'BUCKET', 'ALLOCATION_DATE', 'EXPIRY_DATE', 'AGENT_ID', 'LEGAL_STATUS'
    ],
    sampleRow: [
      ...
      75000, 15000, 100000, 'B3', '2026-08-01', '2026-10-31', 'AGT-001', 'Standard Notice Sent'
    ]
  },
  'one_bank_loan': {
    type: 'one_bank_loan',
    ...
    headers: [
      ...
      'OVERDUE_AMOUNT', 'EMI_AMOUNT', 'DPD_DAYS', 'ALLOCATION_DATE', 'EXPIRY_DATE', 'AGENT_ID'
    ],
    sampleRow: [
      ...
      500000, 245000, 48000, 16000, 90, '2026-07-15', '2026-10-15', 'AGT-002'
    ]
  },
  'dbbl_cc': {
    type: 'dbbl_cc',
    ...
    headers: [
      ...
      'TOTAL_OS', 'OVERDUE_AMOUNT', 'MIN_DUE', 'DPD', 'ALLOCATION_DATE', 'EXPIRY_DATE'
    ],
    sampleRow: [
      ...
      62000, 18500, 6000, 60, '2026-08-01', '2026-09-30'
    ]
  },
  'dbbl_agent_banking': {
    ...
    headers: [
      ...
      'INTEREST_OVERDUE', 'TOTAL_DUE', 'DISBURSEMENT_DATE', 'EXPIRY_DATE'
    ],
    sampleRow: [
      ...
      120000, 25000, 145000, '2025-06-10', '2026-09-10'
    ]
  },
  'asian_paints': {
    type: 'asian_paints',
    ...
    headers: [
      ...
      'OVERDUE_90_PLUS', 'TERRITORY', 'ALLOCATION_DATE', 'EXPIRY_DATE'
    ],
    sampleRow: [
