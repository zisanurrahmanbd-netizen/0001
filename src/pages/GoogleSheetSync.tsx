...
const SHEET_COLUMNS = [
  ...
  { col: 'PRODUCT_NAME', desc: 'Product or card type', example: 'Credit Card' },
  ...
  { col: 'CUSTOMER_PHONE', desc: 'Primary phone number', example: '01712345678' },
  { col: 'CUSTOMER_SECONDARY_PHONE', desc: 'Secondary / alternate phone', example: '01812345678' },
  { col: 'PRESENT_ADDRESS', desc: 'Current / present address', example: 'House 12, Road 4, Dhanmondi, Dhaka' },
  { col: 'PERMANENT_ADDRESS', desc: 'Permanent address', example: 'Village: Karimpur, Dist: Comilla' },
  { col: 'OUTSTANDING_AMOUNT', desc: 'Total outstanding amount (number)', example: '125000' },
  { col: 'OVERDUE_AMOUNT', desc: 'Overdue / past-due amount (number)', example: '45000' },
  { col: 'STATUS', desc: 'Case status (new / in_progress / visited / settled etc.)', example: 'new' },
  { col: 'LEGAL_STATUS', desc: 'Legal status', example: 'Normal Recovery' },
  { col: 'AGENT_NAME', desc: 'Field recovery agent name', example: 'Md. Karim' },
  { col: 'COLLECTOR_NAME', desc: 'Bank-side collector / officer name', example: 'Rina Akter' },
  { col: 'ALLOCATION_DATE', desc: 'Date file was allocated (YYYY-MM-DD)', example: '2024-09-01' },
  { col: 'EXPIRY_DATE', desc: 'File expiry date (YYYY-MM-DD)', example: '2024-09-30' },
];
